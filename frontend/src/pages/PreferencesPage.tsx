...
import type { BudgetBand, TripPace } from '../lib/types'
...
export default function PreferencesPage() {
  ...
  const [budgetBand, setBudgetBand] = useState<BudgetBand>('midRange')
  ...
  useEffect(() => {
    if (!data) return
    setBudgetBand(data.budgetBand)
    setPace(data.pace)
    setInterests(data.interests.join(', '))
    setDietaryNeeds(data.dietaryNeeds ?? '')
